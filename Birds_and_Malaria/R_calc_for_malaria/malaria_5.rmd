...
M4_gam <- gam(log(RMR) ~ s(Cum_Parasitemia, by = Experiment) + Experiment + log(Mass)  + s(Ring, k = 53, bs = "re"),  method = "REML", data = finch_reduced)
...
M6_gam <- gam(log(RMR) ~ s(Cum_Parasitemia, by = Experiment) + Experiment + log(Mass)  + s(Ring, k = 53, bs = "re"),  method = "REML", data = finch_reduced)

M7_gam <- gam(log(RMR) ~ s(Cum_IL, by = Experiment) + Experiment + log(Mass)  + s(Ring, k = 53, bs = "re"),  method = "REML", data = finch_reduced)

M8_gam <- gam(log(RMR) ~ s(IL, by = Experiment) + Experiment + log(Mass)  + s(Ring, k = 53, bs = "re"),  method = "REML", data = finch_reduced)
...
```{r echo=TRUE}
AIC(M1_gam, M2_gam, M3_gam, M4_gam, M5_gam, M6_gam, M7_gam, M8_gam)
...
Pl_Cum_Paras_Cont <- draw(M7_gam, select = c(1), scales = "fixed") + geom_hline(yintercept = 0, linetype = 2)
Pl_Cum_Paras_Exp1 <- draw(M7_gam, select = c(2), scales = "fixed") + geom_hline(yintercept = 0, linetype = 2)
Pl_Cum_Paras_Exp2 <- draw(M7_gam, select = c(3), scales = "fixed") + geom_hline(yintercept = 0, linetype = 2)
...
plot_grid(Pl_Cum_Paras_Exp1, Pl_Cum_Paras_Exp2, nrow = 1) 
...
M4_gam <- gam(log(RMR) ~ s(Cum_Parasitemia, by = Experiment) + Experiment + log(Mass)  + s(Ring, k = 53, bs = "re"),  method = "REML", data = finch_reduced %>% filter(Experiment !="Cont"))

M4_gamA <- gam(log(RMR) ~ s(Cum_Parasitemia) + Experiment + log(Mass)  + s(Ring, k = 53, bs = "re"),  method = "REML", data = finch_reduced %>% filter(Experiment !="Cont"))

AIC(M4_gam, M4_gamA)

M <- gam(log(RMR) ~ s(DPI) + Experiment + log(Mass)  + s(Ring, k = 53, bs = "re"),  method = "REML", data = finch_reduced)

M2 <- gam(log(RMR) ~ s(DPI, by = Experiment) + Experiment + log(Mass)  + s(Ring, k = 53, bs = "re"),  method = "REML", data = finch_reduced)
...
ggplot(finch_il, aes(x = Parasitemia, y = IL6_pg_ml)) + geom_point() + geom_smooth() + facet_wrap(~Experiment)


ggplot(finch_il, aes(x = Cum_Parasitemia, y = IL6_pg_ml)) + geom_point() + geom_smooth() + facet_wrap(~Experiment)



ggplot(finch_il, aes(x = Experiment, y = log(IL6_pg_ml) )) + geom_boxplot()


ggplot(finch_il, aes(x = DPI, y = IL6_pg_ml)) + geom_point() + geom_smooth() + facet_wrap(~Experiment)

ggplot(finch_il, aes(x = DPI, y = Cum_IL)) + geom_point() + geom_smooth() + facet_wrap(~Experiment)


ggplot(finch_il, aes(x = DPI, y = Parasitemia)) + geom_point() + geom_smooth() + facet_wrap(~Experiment)

ggplot(finch_il, aes(x = DPI, y = Cum_Parasitemia)) + geom_point() + geom_smooth() + facet_wrap(~Experiment)
