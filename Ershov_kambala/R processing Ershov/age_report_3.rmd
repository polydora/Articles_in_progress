...
Из анализа были исключены возрастные группы 1+, отлов которых имеющимися средствами не дает реперзентативной выборки. 

Поскольку обилие рыб возрастом более 7+ было невелико, всех рыб с возрстом 8+ - 13+ объединили в одну группу, возраст рыб в этой группе рассматривался, как среднее значение возраста. 
