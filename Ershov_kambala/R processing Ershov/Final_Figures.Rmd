...
Pl_pay_charts <-
 ...
 ggsave(plot = Pl_pay_charts, filename = "Pay_charts_with_left_proportion.pdf")
 
 ggsave(plot = Pl_pay_charts, filename = "Pay_charts_with_left_proportion.tiff")  

 ggsave(plot = Pl_pay_charts, filename = "Pay_charts_with_left_proportion.png")  
