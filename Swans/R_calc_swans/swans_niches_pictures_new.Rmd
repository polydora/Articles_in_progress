...
```{r}
Pl_cygnets <- plot_grid(Pl_Cygnets_Young, Pl_Cygnets_Old, nrow = 2)

ggsave(plot = Pl_cygnets, filename = "Figures/Pl_cygnets.png", dpi = 600)

```



```{r, fig.cap = "Рисунок ++. Связь обилия выводков лебедя-шипуна с расстоянием от берега и глубиной в соответствии с моделью GAMM2.Relationship between the abundance of mute swan broods and distance from shore and depth according to the GAMM2 model." }

include_graphics("Figures/Pl_cygnets.png")
