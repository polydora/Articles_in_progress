...
- По феноменологии - диссеминированная неоплазия (DN)
...
- Линии $BTN1$ и $BTN2$ будучи по происхождению клетками  одного «родительского» вида (*M.trossulus*), близкого эволюционного возраста должны иметь сходные связи с факторами среды.
...
- Единственное место где с «уловимой» частотой представлены обе линии $BTN$
