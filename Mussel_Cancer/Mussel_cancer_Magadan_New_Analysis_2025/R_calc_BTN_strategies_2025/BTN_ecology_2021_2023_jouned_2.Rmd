...
```{r}
Mod <- gam(cbind(N_cancer, N_helthy) ~ s((Dist_Port), by = Lineage,  bs = "cr", k = 5) + s((fetch), by = Lineage,  bs = "cr", k = 5) +  s((PC1), by = Lineage,  bs = "cr", k = 5) + s((OGP), by = Lineage, bs = "cr", k = 5) +  Lineage +  s(Year, Site, bs = "re"),  family = "binomial", method = "REML", data = cancer_21_23_predictors )
