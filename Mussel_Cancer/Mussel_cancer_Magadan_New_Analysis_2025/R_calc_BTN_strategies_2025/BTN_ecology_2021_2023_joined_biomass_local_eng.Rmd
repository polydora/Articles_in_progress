...
# Здесь какая-то загадочная история. Если считать модель по данным из Mussel_growth_Magadan_2021_2023.xlsx, то связь с OGP становится не значимой, но если брать данные из файла, который является репликой экселевского файла, то все ОК, связь значима. 


growth <- read.table("Data/Mussel_growth_Magadan_2021_2023.csv", sep = ";", header = T, dec = ",")

growth_1 <- read_excel("Data/Mussel_growth_Magadan_2021_2023.xlsx", na = "NA")
...
sm %>%
  ...
  labs(x = "Proportion (%) of aneuploid cells", y = "Proportion of gamete-free specimens") +
  # ylim(-5, 4)+
