...
cancer_predictors_2021 <-
merge(cancer_2021, predictors_21 )
```
...
predict(Mod_btn1_btn2_no_re, newdata = cancer_predictors_2021, type = "response")
```


```{r}
cancer_predictors_2021 %>% 
  ggplot(aes(PC1, Prop_BTN1)) +
  geom_point()


  cor.test(x = cancer_predictors_2021$PC1, y = cancer_predictors_2021$Prop_BTN1, method = "pearson")


cancer_predictors_2021 %>% 
  ggplot(aes(PC1, Prop_BTN2)) +
  geom_point()

cor.test(x = cancer_predictors_2021$PC1, y = cancer_predictors_2021$Prop_BTN2, method = "pearson")


cancer_predictors_2021 %>% 
  ggplot(aes(Dist_Port, Prop_BTN1)) +
  geom_point()

cor.test(x = cancer_predictors_2021$Dist_Port, y = cancer_predictors_2021$Prop_BTN1, method = "pearson")


cancer_predictors_2021 %>% 
  ggplot(aes(Dist_Port, Prop_BTN2)) +
  geom_point()

cor.test(x = cancer_predictors_2021$Dist_Port, y = cancer_predictors_2021$Prop_BTN2, method = "pearson")
...
cor.test(x = cancer_predictors_2021$fetch, y = cancer_predictors_2021$Prop_BTN1, method = "pearson")
...
cor.test(x = cancer_predictors_2021$fetch, y = cancer_predictors_2021$Prop_BTN2, method = "pearson")


cancer_predictors_2021 %>% 
  ggplot(aes(OGP, Prop_BTN1)) +
  geom_point()

cor.test(x = cancer_predictors_2021$OGP, y = cancer_predictors_2021$Prop_BTN1, method = "pearson")


cancer_predictors_2021 %>% 
  ggplot(aes(OGP, Prop_BTN2)) +
  geom_point()

cor.test(x = cancer_predictors_2021$OGP, y = cancer_predictors_2021$Prop_BTN2, method = "pearson")
