...
```{r fig.cap="Точки сбора материала в 2023 г., использованные для анализа влияния экологических факторов на распространение BTN. Размер точек пропоционален степени открытости побережья. Серыми точками обозначены сайты, находящиеся в зоне антропогенного влияния."}
