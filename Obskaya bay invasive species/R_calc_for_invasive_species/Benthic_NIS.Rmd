...
# write.csv(df_species, "benthos_occurence_all.csv" )
...
df_species_plancton1 <- read.csv("Data/plancton_occurence.csv")

df_species_plancton1 <- unique(df_species_plancton1)


df_species_plancton2 <- read.csv("Data/plancton_occurence_2.csv")
df_species_plancton2 <- unique(df_species_plancton2)

df_species_plancton <- rbind(df_species_plancton1, df_species_plancton2) 
...
PNIS_plancton <- c(include, "Acanthocyclops robustus", "Acartia bifilosa", "Acartia tonsa", "Paracalanus parvus")
...
# write.csv(df_species_plancton, "plancton_occurence_all.csv")
