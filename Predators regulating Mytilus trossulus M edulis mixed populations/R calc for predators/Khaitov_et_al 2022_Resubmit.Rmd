...
Pl_baster <- ggplot(all_ast_abund, aes(x = Stage2, y = B_aster)) + 
  geom_boxplot(fill = "gray") + 
  theme(axis.title.x = element_blank(), axis.text.x = element_blank()) + 
  labs(y = "Starfish biomass (g )") +
  theme(axis.text.x = element_blank(), axis.text.y = element_text(size = 14), axis.title.y = element_text(size = 15))



Pl_N_alive <- ggplot(all_ast_abund, aes(x = Stage2, y = N_alive)) + 
  geom_boxplot(fill = "gray") + 
  theme(axis.title.x = element_blank(), axis.text.x = element_blank()) + 
  labs(y = "Abundance of alive mussels") +
  theme(axis.text.x = element_blank(), axis.text.y = element_text(size = 14), axis.title.y = element_text(size = 15))

 

Pl_Prop_dead <- ggplot(all_ast_abund, aes(x = Stage2, y = Prop_dead)) + 
  geom_boxplot(fill = "gray") + 
  theme(axis.title.x = element_blank(), axis.text.x = element_blank())+ 
  labs(y = "Proportion of dead shells") +
  theme(axis.text.x = element_blank(), axis.text.y = element_text(size = 14), axis.title.y = element_text(size = 15))
...
Pl_PT <- 
  ...
  geom_text(data = compar, aes(x = Stage2, y = y, label = Lab), size = 9) +
  theme(axis.text.x = element_text(size = 20), axis.text.y = element_text(size = 14), axis.title.y = element_text(size = 15))
