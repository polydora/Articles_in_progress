...
$$
GAM : Prevalence = s(Dist_{Port}|Lineage) + s(Fetch|Lineage) + s(PC1|Lineage) +s(OGP|Lineage) + Lineage
$$
...
```{r, fig.width=10}
plot_grid(Pl_BTN1_Port, Pl_BTN1_Fetch, Pl_BTN1_PC1, Pl_BTN1_OGP, ncol = 2)
```
