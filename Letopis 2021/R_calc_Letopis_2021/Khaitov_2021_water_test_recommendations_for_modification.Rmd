---
title: "Оценка количества гнезд гаги обыкновенной, необходимых для применения водного теста"
author: "В. М. Хайтов"
output: 
      word_document:
                ...
                fig_height: 5
abstract: |
    **Хайтов В. М. Оценка количества гнезд гаги обыкновенной, необходимых для применения водного теста** // Марченков А.В. (ред.) Летопись природы Кадалакшского заповедника за 2021 год (ежегодный отчет). Кандалакша. Т.1 (Летопись природы Кандалакшского заповедника, кн. ++)
    Методом симуляции выборок была проведена оценка минимального количества гнезд гаги, в которых необходимо проанализировать кладки с применением водного теста. Показано, что тотальное применение водного теста ко всем гнездам избыточно. Для характеристики сроков начала гнездования на данном острове достаточно применить водный тест к части гнезд. Приводится оценка минимального количества гнезд.   
    
    **Khaitov V.M.     Estimation of the number of Common Eider nests required for water test application** // Marchenkov A. V. (ed.)  The Chronicle of Nature by the Kandalaksha Reserve for 2021 (Annual report).  Kandalaksha. V.1. (The Chronicle of Nature by the Kandalaksha Reserve, Book N ++)
    The minimum number of eider nests to be analyzed with the water test was estimated by the sampling simulation method. It was shown that total application of the water test to all nests was excessive. To characterize the clutch beginning time for a given island, it is sufficient to apply the water test to part of the nests. An estimate of the minimum number of nests is given. 
