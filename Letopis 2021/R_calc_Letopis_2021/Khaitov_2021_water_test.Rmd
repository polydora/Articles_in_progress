...
kable(wtest_generalized_print, col.names = c("Остров", "Количество гнезд", "Количество проанализированных яиц","Среднее значение даты начала откладки яиц (дни от 1 января)", "Стандартное отклонение", "Отклонение от среднего значения (дни)"), caption = "Табл. +.2. Средние значения сроков начала откладки яиц на разных островах. Mean values of the beginning of egg laying date on different islands.")
```
