...
************************************
At! Надо провести spenvcor() для интерпретации каноничеких осей!!!!!!
Плюс надо провести еще и такой анализ     
spec_inertia <- inertcomp(mite_cca, display = c("species"), 
                                  proportional = FALSE )
Это даст виды  наиболее чуствительные к факторам, включенным в модель
