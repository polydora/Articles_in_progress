...
В ячейках матрицы находились даты, когда происходило соответствующее событие (число дней, прошедших с 1-го января соответствующего года).
...
plankt_wide <- plankt_wide[!(plankt_wide$Year %in% year_exclude), ]
...
# Abundance <- Abundance[!(Abundance$Year %in% year_exclude),]
