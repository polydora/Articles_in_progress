...
Pl_phen1 <- Pl_phen_begin + geom_text(data = slopes_event [slopes_event$Event == "Begin", ], aes(label = label, x = 1961, y = max + 5), size = 3, hjust = "inward") + scale_y_continuous(breaks=c(50,100, 150, 200, 250, 300, 350))

Pl_phen2 <- Pl_phen_end + geom_text(data = slopes_event[slopes_event$Event == "End", ], aes(label = label, x = 1961, y = max + 5), size = 3, hjust = "inward") + scale_y_continuous(breaks=c(50,100, 150, 200, 250, 300, 350))
...
labels_events <- c( "ICD" = "Julian day of Ice cleaning",   
                    "SpSD" = "Julian day of Spring start",
                    "SuSD" = "Julian day of Summer start",
                    "TPD" = "Julian day of Temp. peak ",
                    "SuFD" = "Julian day of Summer finish",
                    "SuDur"= "Summer duration (days)",
                    "SpT" = "Spring Temperature (°C)",
                    "SuT" = "Summer Temperature (°C)",
                    "NAO" = "NAO",
                    "AOI" = "AOI"  
                  )
