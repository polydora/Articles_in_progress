...
**Модель 7**, описывающия связь между Ptros и PT для всех изученных регионов
...
eq_Model_6_WBL_E <- paste0('$$P(edu|E) = \\frac{e^{', intercept, ' + ', b1, 'Ptros} }{1 + e^{', intercept, ' + ', b1, 'Ptros}}$$')
...
eq_Model_6_WBL_T <- paste0('$$P(tros|E) = \\frac{e^{', intercept, ' + ', b1, 'Ptros} }{1 + e^{', intercept, ' + ', b1, 'Ptros}}$$')
...
eq_Model_6_BH_E <- paste0('$$P(edu|E) = \\frac{e^{', intercept, ' + ', b1, 'Ptros} }{1 + e^{', intercept, ' + ', b1, 'Ptros}}$$')
...
eq_Model_6_BH_T <- paste0('$$P(tros|T) = \\frac{e^{', intercept, ' + ', b1, 'Ptros} }{1 + e^{', intercept, ' + ', b1, 'Ptros}}$$')
...
eq_Model_6_GOM_E <- paste0('$$P(edu|E) = \\frac{e^{', intercept, ' + ', b1, 'Ptros} }{1 + e^{', intercept, ' + ', b1, 'Ptros}}$$')
...
eq_Model_6_GOM_T <- paste0('$$P(tros|T) = \\frac{e^{', intercept, ' + ', b1, 'Ptros} }{1 + e^{', intercept, ' + ', b1, 'Ptros}}$$')
...
eq_Model_6_BALT_E <- paste0('$$P(edu|E) = \\frac{e^{', intercept, ' + ', b1, 'Ptros} }{1 + e^{', intercept, ' + ', b1, 'Ptros}}$$')
...
eq_Model_6_BALT_T <- paste0('$$P(tros|T) = \\frac{e^{', intercept, ' + ', b1, 'Ptros} }{1 + e^{', intercept, ' + ', b1, 'Ptros}}$$')
...
eq_Model_6_NORW_E <- paste0('$$P(edu|E) = \\frac{e^{', intercept, ' + ', b1, 'Ptros} }{1 + e^{', intercept, ' + ', b1, 'Ptros}}$$')
...
eq_Model_6_NORW_T <- paste0('$$P(tros|T) = \\frac{e^{', intercept, ' + ', b1, 'Ptros} }{1 + e^{', intercept, ' + ', b1, 'Ptros}}$$')
