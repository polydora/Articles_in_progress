...
Pl_Eq1_2_all_diff <- 
  ggplot() + 
  geom_point(data = all_obs_predict_T %>% filter(N_edu > n_select), aes(x = P_ME_E_obs, y = P_ME_E_Eq2_all_diff), color = "blue", size = 2) +
  geom_point(data = all_obs_predict_T %>% filter(N_tros > n_select), aes(x = P_MT_T_obs, y = P_MT_T_Eq1_all_diff), color = "red", size = 2) +
  geom_abline()  + xlim(0,1) + ylim(0,1) +
  geom_smooth(data = all_obs_predict_T %>% filter(N_edu > n_select), aes(x = P_ME_E_obs, y = P_ME_E_Eq2_all_diff), color = "blue", se = F, method = "lm") +
  geom_smooth(data = all_obs_predict_T %>% filter(N_tros > n_select), aes(x = P_MT_T_obs, y = P_MT_T_Eq1_all_diff), color = "red", se = F, method = "lm")


Pl_Eq1_2_diff_mix <- 
  ggplot() + 
  geom_point(data = all_obs_predict_T %>% filter(N_edu > n_select), aes(x = P_ME_E_obs, y = P_ME_E_Eq2_diff_mix, size = N_edu), color = "blue") +
  geom_point(data = all_obs_predict_T %>% filter(N_tros > n_select), aes(x = P_MT_T_obs, y = P_MT_T_Eq1_diff_mix, size = N_tros), color = "red") +
  geom_abline()  + xlim(0,1) + ylim(0,1) +
  geom_smooth(data = all_obs_predict_T %>% filter(N_edu > n_select), aes(x = P_ME_E_obs, y = P_ME_E_Eq2_diff_mix), color = "blue", se = F, method = "lm") +
  geom_smooth(data = all_obs_predict_T %>% filter(N_tros > n_select), aes(x = P_MT_T_obs, y = P_MT_T_Eq1_diff_mix), color = "red", se = F, method = "lm")



Pl_Eq1_2_diff_all <- 
  ggplot() + 
  geom_point(data = all_obs_predict_T %>% filter(N_edu > n_select), aes(x = P_ME_E_obs, y = P_ME_E_Eq2_diff_all), color = "blue", size = 2) +
  geom_point(data = all_obs_predict_T %>% filter(N_tros > n_select), aes(x = P_MT_T_obs, y = P_MT_T_Eq1_diff_all), color = "red", size = 2) +
  geom_abline()  + xlim(0,1) + ylim(0,1) +
  geom_smooth(data = all_obs_predict_T %>% filter(N_edu > n_select), aes(x = P_ME_E_obs, y = P_ME_E_Eq2_diff_all), color = "blue", se = F, method = "lm") +
  geom_smooth(data = all_obs_predict_T %>% filter(N_tros > n_select), aes(x = P_MT_T_obs, y = P_MT_T_Eq1_diff_all), color = "red", se = F, method = "lm")
...
Pl_Eq1_2_all_mix <- 
  ggplot() + 
  geom_point(data = all_obs_predict_T %>% filter(N_edu > n_select), aes(x = P_ME_E_obs, y = P_ME_E_Eq2_all_mix), color = "blue", size = 2) +
  geom_point(data = all_obs_predict_T %>% filter(N_tros > n_select), aes(x = P_MT_T_obs, y = P_MT_T_Eq1_all_mix), color = "red", size = 2) +
  geom_abline()  + xlim(0,1) + ylim(0,1) +
  geom_smooth(data = all_obs_predict_T %>% filter(N_edu > n_select), aes(x = P_ME_E_obs, y = P_ME_E_Eq2_all_mix), color = "blue", se = F, method = "lm") +
  geom_smooth(data = all_obs_predict_T %>% filter(N_tros > n_select), aes(x = P_MT_T_obs, y = P_MT_T_Eq1_all_mix), color = "red", se = F, method = "lm")


Pl_Eq1_2_all_all <- 
  ggplot() + 
  geom_point(data = all_obs_predict_T %>% filter(N_edu > n_select), aes(x = P_ME_E_obs, y = P_ME_E_Eq2_all_all), color = "blue", size = 2) +
  geom_point(data = all_obs_predict_T %>% filter(N_tros > n_select), aes(x = P_MT_T_obs, y = P_MT_T_Eq1_all_all), color = "red", size = 2) +
  geom_abline()  + xlim(0,1) + ylim(0,1) +
  geom_smooth(data = all_obs_predict_T %>% filter(N_edu > n_select), aes(x = P_ME_E_obs, y = P_ME_E_Eq2_all_all), color = "blue", se = F, method = "lm") +
  geom_smooth(data = all_obs_predict_T %>% filter(N_tros > n_select), aes(x = P_MT_T_obs, y = P_MT_T_Eq1_all_all), color = "red", se = F, method = "lm")


Pl_Eq1_2_mix_diff <- 
  ggplot() + 
  geom_point(data = all_obs_predict_T %>% filter(N_edu > n_select), aes(x = P_ME_E_obs, y = P_ME_E_Eq2_mix_diff), color = "blue", size = 2) +
  geom_point(data = all_obs_predict_T %>% filter(N_tros > n_select), aes(x = P_MT_T_obs, y = P_MT_T_Eq1_mix_diff), color = "red", size = 2) +
  geom_abline()  + xlim(0,1) + ylim(0,1) +
  geom_smooth(data = all_obs_predict_T %>% filter(N_edu > n_select), aes(x = P_ME_E_obs, y = P_ME_E_Eq2_mix_diff), color = "blue", se = F, method = "lm") +
  geom_smooth(data = all_obs_predict_T %>% filter(N_tros > n_select), aes(x = P_MT_T_obs, y = P_MT_T_Eq1_mix_diff), color = "red", se = F, method = "lm")



Pl_Eq1_2_mix_mix <- 
  ggplot() + 
  geom_point(data = all_obs_predict_T %>% filter(N_edu > n_select), aes(x = P_ME_E_obs, y = P_ME_E_Eq2_mix_mix), color = "blue", size = 2) +
  geom_point(data = all_obs_predict_T %>% filter(N_tros > n_select), aes(x = P_MT_T_obs, y = P_MT_T_Eq1_mix_mix), color = "red", size = 2) +
  geom_abline()  + xlim(0,1) + ylim(0,1) +
  geom_smooth(data = all_obs_predict_T %>% filter(N_edu > n_select), aes(x = P_ME_E_obs, y = P_ME_E_Eq2_mix_mix), color = "blue", se = F, method = "lm") +
  geom_smooth(data = all_obs_predict_T %>% filter(N_tros > n_select), aes(x = P_MT_T_obs, y = P_MT_T_Eq1_mix_mix), color = "red", se = F, method = "lm")

Pl_Eq1_2_mix_all <- 
  ggplot() + 
  geom_point(data = all_obs_predict_T %>% filter(N_edu > n_select), aes(x = P_ME_E_obs, y = P_ME_E_Eq2_mix_all), color = "blue", size = 2) +
  geom_point(data = all_obs_predict_T %>% filter(N_tros > n_select), aes(x = P_MT_T_obs, y = P_MT_T_Eq1_mix_all), color = "red", size = 2) +
  geom_abline()  + xlim(0,1) + ylim(0,1) +
  geom_smooth(data = all_obs_predict_T %>% filter(N_edu > n_select), aes(x = P_ME_E_obs, y = P_ME_E_Eq2_mix_all), color = "blue", se = F, method = "lm") +
  geom_smooth(data = all_obs_predict_T %>% filter(N_tros > n_select), aes(x = P_MT_T_obs, y = P_MT_T_Eq1_mix_all), color = "red", se = F, method = "lm")



grid.arrange(Pl_Eq3_diff, Pl_Eq3_mix, Pl_Eq3_all, Pl_Eq1_2_all_diff, Pl_Eq1_2_diff_mix, Pl_Eq1_2_diff_all, Pl_Eq1_2_mix_diff, Pl_Eq1_2_mix_mix, Pl_Eq1_2_mix_all, Pl_Eq1_2_all_diff, Pl_Eq1_2_all_mix, Pl_Eq1_2_all_all, ncol = 3)
