...
myt <- read.table("data_salinity3_a.csv", header = T, sep = ",")
...
Model_T_MT <- lm(prop_MT_adj ~ Prop_T*sea*sal_place, data = prop_T_MT) 

drop1(Model_T_MT, test = "F")


Model_T_MT_2 <- update(Model_T_MT, .~.-Prop_T:sea:sal_place)

drop1(Model_T_MT_2, test = "F")

Model_T_MT_3 <- update(Model_T_MT_2, .~.-Prop_T:sea)

drop1(Model_T_MT_3, test = "F")

Model_T_MT_4 <- update(Model_T_MT_3, .~.-Prop_T:sal_place)

drop1(Model_T_MT_4, test = "F")
