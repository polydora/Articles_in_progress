...
Pl_Eq3 <- all_obs_predict_T %>% filter(Set == "WBL") %>% ggplot(aes(y = Ptros_obs, shape = Set)) + geom_point(size = 3)  + theme(legend.position = "bottom")   + geom_abline()  



Pl_Eq3_diff <- Pl_Eq3 + aes(x = Ptros_Eq3_diff) +  ggtitle(paste("SSE =", all_obs_predict_T %>% filter(Set == "WBL") %>% summarise(SSE = sum( (Ptros_obs - Ptros_Eq3_diff)^2, na.rm = T )/sum(!is.na(Ptros_Eq3_diff))) %>% round(., 3)))+ guides(shape = "none", color = "none") + xlim(0,1) + ylim(0,1)

                                                                                            
Pl_Eq3_mix <- Pl_Eq3 + aes(x = Ptros_Eq3_mix) +  ggtitle(paste("SSE =", all_obs_predict_T %>% filter(Set == "WBL") %>% summarise(SSE = sum( (Ptros_obs - Ptros_Eq3_mix)^2, na.rm = T )/sum(!is.na(Ptros_Eq3_mix))) %>% round(., 3)))+ guides(shape = "none", color = "none") + xlim(0,1) + ylim(0,1)
                                                                                            
                                                                                            
Pl_Eq3_all <- Pl_Eq3 + aes(x = Ptros_Eq3_all) +  ggtitle(paste("SSE =", all_obs_predict_T %>% filter(Set == "WBL") %>% summarise(SSE = sum( (Ptros_obs - Ptros_Eq3_all)^2, na.rm = T )/sum(!is.na(Ptros_Eq3_all))) %>% round(., 3))) + guides(shape = "none", color = "none") + xlim(0,1) + ylim(0,1)
                                                                                            



Pl_Eq1_2_dif_dif <- cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_diff_diff, P_ME_E_Eq2_diff_diff) %>% melt(value.name = "Predicted") %>% select(Predicted))  %>%   ggplot(aes(shape = Set)) + geom_point(aes(y = Observed, x = Predicted, color = variable))  + theme(legend.position = "bottom")   + geom_abline() +  
  ggtitle("SSE =", cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_diff_diff, P_ME_E_Eq2_diff_diff) %>% melt(value.name = "Predicted") %>% select(Predicted)) %>% summarise(SSE = sum((Observed - Predicted)^2, na.rm = T)/sum(!is.na(Predicted))) %>% round(3)) + guides(shape = "none", color = "none") + xlim(0,1) + ylim(0,1)



  
  
Pl_Eq1_2_dif_mix <- cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_diff_mix, P_ME_E_Eq2_diff_mix) %>% melt(value.name = "Predicted") %>% select(Predicted))  %>%   ggplot(aes(shape = Set)) + geom_point(aes(y = Observed, x = Predicted, color = variable))  + theme(legend.position = "bottom")   + geom_abline() +  
  ggtitle("SSE =", cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_diff_mix, P_ME_E_Eq2_diff_mix) %>% melt(value.name = "Predicted") %>% select(Predicted)) %>% summarise(SSE = sum((Observed - Predicted)^2, na.rm = T)/sum(!is.na(Predicted))) %>% round(.,3)) + guides(shape = "none", color = "none") + xlim(0,1) + ylim(0,1)



  
Pl_Eq1_2_dif_all <- cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_diff_all, P_ME_E_Eq2_diff_all) %>% melt(value.name = "Predicted") %>% select(Predicted))  %>%   ggplot(aes(shape = Set)) + geom_point(aes(y = Observed, x = Predicted, color = variable))  + theme(legend.position = "bottom")   + geom_abline() +  
  ggtitle("SSE =", cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_diff_all, P_ME_E_Eq2_diff_all) %>% melt(value.name = "Predicted") %>% select(Predicted)) %>% summarise(SSE = sum((Observed - Predicted)^2, na.rm = T)/sum(!is.na(Predicted))) %>% round(3)) + guides(shape = "none", color = "none") + xlim(0,1) + ylim(0,1)


Pl_Eq1_2_mix_dif <- cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_mix_diff, P_ME_E_Eq2_mix_diff) %>% melt(value.name = "Predicted") %>% select(Predicted))  %>%   ggplot(aes(shape = Set)) + geom_point(aes(y = Observed, x = Predicted, color = variable))  + theme(legend.position = "bottom")   + geom_abline() +  
  ggtitle("SSE =", cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_mix_diff, P_ME_E_Eq2_mix_diff) %>% melt(value.name = "Predicted") %>% select(Predicted)) %>% summarise(SSE = sum((Observed - Predicted)^2, na.rm = T)/sum(!is.na(Predicted))) %>% round(3)) + guides(shape = "none", color = "none") + xlim(0,1) + ylim(0,1)


Pl_Eq1_2_mix_mix <- cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_mix_mix, P_ME_E_Eq2_mix_mix) %>% melt(value.name = "Predicted") %>% select(Predicted))  %>%   ggplot(aes(shape = Set)) + geom_point(aes(y = Observed, x = Predicted, color = variable))  + theme(legend.position = "bottom")   + geom_abline() +  
  ggtitle("SSE =", cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_mix_mix, P_ME_E_Eq2_mix_mix) %>% melt(value.name = "Predicted") %>% select(Predicted)) %>% summarise(SSE = sum((Observed - Predicted)^2, na.rm = T)/sum(!is.na(Predicted))) %>% round(3)) + guides(shape = "none", color = "none") + xlim(0,1) + ylim(0,1)



Pl_Eq1_2_mix_all <- cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_mix_all, P_ME_E_Eq2_mix_all) %>% melt(value.name = "Predicted") %>% select(Predicted))  %>%   ggplot(aes(shape = Set)) + geom_point(aes(y = Observed, x = Predicted, color = variable))  + theme(legend.position = "bottom")   + geom_abline() +  
  ggtitle("SSE =", cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_mix_all, P_ME_E_Eq2_mix_all) %>% melt(value.name = "Predicted") %>% select(Predicted)) %>% summarise(SSE = sum((Observed - Predicted)^2, na.rm = T)/sum(!is.na(Predicted))) %>% round(3)) + guides(shape = "none", color = "none") + xlim(0,1) + ylim(0,1)





Pl_Eq1_2_all_diff <- cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_all_diff, P_ME_E_Eq2_all_diff) %>% melt(value.name = "Predicted") %>% select(Predicted))  %>%   ggplot(aes(shape = Set)) + geom_point(aes(y = Observed, x = Predicted, color = variable))  + theme(legend.position = "bottom")   + geom_abline() +  
  ggtitle("SSE =", cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_all_diff, P_ME_E_Eq2_all_diff) %>% melt(value.name = "Predicted") %>% select(Predicted)) %>% summarise(SSE = sum((Observed - Predicted)^2, na.rm = T)/sum(!is.na(Predicted))) %>% round(3)) + guides(shape = "none", color = "none") + xlim(0,1) + ylim(0,1)



Pl_Eq1_2_all_mix <- cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_all_mix, P_ME_E_Eq2_all_mix) %>% melt(value.name = "Predicted") %>% select(Predicted))  %>%   ggplot(aes(shape = Set)) + geom_point(aes(y = Observed, x = Predicted, color = variable))  + theme(legend.position = "bottom")   + geom_abline() +  
  ggtitle("SSE =", cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_all_mix, P_ME_E_Eq2_all_mix) %>% melt(value.name = "Predicted") %>% select(Predicted)) %>% summarise(SSE = sum((Observed - Predicted)^2, na.rm = T)/sum(!is.na(Predicted))) %>% round(3)) + guides(shape = "none", color = "none")+ xlim(0,1) + ylim(0,1)



Pl_Eq1_2_all_all <- cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_all_all, P_ME_E_Eq2_all_all) %>% melt(value.name = "Predicted") %>% select(Predicted))  %>%   ggplot(aes(shape = Set)) + geom_point(aes(y = Observed, x = Predicted, color = variable))  + theme(legend.position = "bottom")   + geom_abline() +  
  ggtitle("SSE =", cbind(all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_obs, P_ME_E_obs) %>% melt(value.name = "Observed"), all_obs_predict_T %>% filter(Set == "WBL") %>% select(P_MT_T_Eq1_all_all, P_ME_E_Eq2_all_all) %>% melt(value.name = "Predicted") %>% select(Predicted)) %>% summarise(SSE = sum((Observed - Predicted)^2, na.rm = T)/sum(!is.na(Predicted))) %>% round(3)) + guides(shape = "none", color = "none") + xlim(0,1) + ylim(0,1)


grid.arrange(Pl_Eq3_diff, Pl_Eq3_mix, Pl_Eq3_all, Pl_Eq1_2_dif_dif, Pl_Eq1_2_dif_mix, Pl_Eq1_2_dif_all, Pl_Eq1_2_mix_dif, Pl_Eq1_2_mix_mix, Pl_Eq1_2_mix_all, Pl_Eq1_2_all_diff, Pl_Eq1_2_all_mix, Pl_Eq1_2_all_all, ncol = 3)
