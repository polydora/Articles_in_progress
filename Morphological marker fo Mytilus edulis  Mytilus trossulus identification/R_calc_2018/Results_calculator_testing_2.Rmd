...
Разработка идеи ППС про то как будет выглядеть качество оценки Ptros по PT  в завивисимости от Delta. Для этого анализа Ptros оценивается по PT в соответствии с Eq1. 

Goodness =  Ptros_observed - Ptros_Eq3
...
P(edu|E) и P(tros|T) оцениваются на основе Ptros, вычисленной по   
