...
hydr_lonf_print$Water_T <- round(hydr_lonf_print$Water_T, 1)
hydr_lonf_print$S <- round(hydr_lonf_print$S, 1)

kable(hydr_lonf_print, col.names = c("Месяц/Число/Год Время", "Температура воды", "Соленость"), 
      caption = "**Таблица +.1**  Температура воды и соленость в Южной губе о. Ряжкова в 2007 - 2019 гг. Water temperature and salinity in the Youzhnaza inlet (Ryazhkov island) in 2007 - 2019.")  
```
