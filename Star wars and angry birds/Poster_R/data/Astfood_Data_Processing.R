...
Pl_alive <- ggplot(total_N, aes(x ="", y = alive, fill = variable)) + geom_bar(stat= "identity", width=1, color = "black") + coord_polar("y", start=0)  + theme(axis.text = element_blank(), panel.grid = element_blank(), panel.border = element_blank(), axis.title = element_blank())+ guides(fill="none") + ggtitle("Живые") + theme(plot.title = element_text(hjust = 0.5))

Pl_dead <- ggplot(total_N, aes(x ="", y = dead, fill = variable)) + geom_bar(stat= "identity", width=1, color = "black") + coord_polar("y", start=0) + theme(axis.text = element_blank(), panel.grid = element_blank(), panel.border = element_blank(), axis.title = element_blank()) + guides(fill="none")+ ggtitle("Съеденные") + theme(plot.title = element_text(hjust = 0.5))
...
ggplot(hem_abund, aes(x = N_dead, y = N_alive)) + geom_point()  
...
ggplot(hem_abund_bank, aes(x = N_dead, y = N_alive)) + geom_point()  
