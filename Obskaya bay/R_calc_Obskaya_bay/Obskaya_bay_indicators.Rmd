...
Два вида, попадающие во второй квадрант ординации (*Portlandia aestuariorum*, *Diastylis sulcata*) нельзя отнести к числу индикаторов, так как они на ординации ни достаточно далеко располагаются о центроида *Disturbed*.  
