...
Pl_Obskaya_bay + geom_point(data = bent_env2, aes(x = Long, y = Lat, size = bent_bio2$Marenzelleria_sp., group = 1, color = log(bent_bio2$Marenzelleria_sp.+1) ) ) + 
  ...
  guides(color = FALSE) + labs(size ="") + ggtitle("Marenzelleria spp.") +
  geom_point(aes(x = Sabetta_x, y = Sabetta_y, group = 1), size = 3, shape = 22, fill = "blue") + 
  geom_point(aes(x = Terminal_x, y = Terminal_y, group = 1), size = 3, shape = 22, fill = "blue") +
...
Pl_Sipunc <-
Pl_Obskaya_bay + geom_point(data = bent_env2, aes(x = Long, y = Lat, size = bent_bio2$Sipunculidea_gen._sp., group = 1, color = log(bent_bio2$Sipunculidea_gen._sp.+1) ) ) + scale_color_gradient(low = "white", high = "black") + guides(color = FALSE) + labs(size ="") + ggtitle("Sipunculida gen. sp.") +geom_point(aes(x = Sabetta_x, y = Sabetta_y), size = 3, shape = 22, fill = "blue") +   geom_point(aes(x = Sabetta_x, y = Sabetta_y, group = 1), size = 3, shape = 22, fill = "blue") + 
  geom_point(aes(x = Terminal_x, y = Terminal_y, group = 1), size = 3, shape = 22, fill = "blue") +
  geom_polygon(data = chanel_df, aes(x = X, y = Y), fill = "black", group = 1)


Pl_Sadur <-
Pl_Obskaya_bay + geom_point(data = bent_env2, aes(x = Long, y = Lat, size = bent_bio2$Saduria_entomon, group = 1, color = log(bent_bio2$Saduria_entomon +1) ) ) + scale_color_gradient(low = "white", high = "black") + guides(color = FALSE) + labs(size ="") + ggtitle("S. entomon") + geom_point(aes(x = Sabetta_x, y = Sabetta_y), size = 3, shape = 22, fill = "blue") + 
  geom_point(aes(x = Sabetta_x, y = Sabetta_y, group = 1), size = 3, shape = 22, fill = "blue") + 
  geom_point(aes(x = Terminal_x, y = Terminal_y, group = 1), size = 3, shape = 22, fill = "blue") +
  geom_polygon(data = chanel_df, aes(x = X, y = Y), fill = "black", group = 1)

Pl_Port <-
Pl_Obskaya_bay + geom_point(data = bent_env2, aes(x = Long, y = Lat, size = bent_bio2$Portlandia_aestuariorum, group = 1, color = log(bent_bio2$Saduria_entomon +1) ) ) + scale_color_gradient(low = "white", high = "black") + guides(color = FALSE) + labs(size ="") + ggtitle("P. aestuariorum") + geom_point(aes(x = Sabetta_x, y = Sabetta_y), size = 3, shape = 22, fill = "blue") +   geom_point(aes(x = Sabetta_x, y = Sabetta_y, group = 1), size = 3, shape = 22, fill = "blue") + 
  geom_point(aes(x = Terminal_x, y = Terminal_y, group = 1), size = 3, shape = 22, fill = "blue") +
  geom_polygon(data = chanel_df, aes(x = X, y = Y), fill = "black", group = 1)

Pl_Diast <-
Pl_Obskaya_bay + geom_point(data = bent_env2, aes(x = Long, y = Lat, size = bent_bio2$Diastylis_sulcata, group = 1, color = log(bent_bio2$Saduria_entomon +1) ) ) + scale_color_gradient(low = "white", high = "black") + guides(color = FALSE) + labs(size ="") + ggtitle("D. sulcata") + geom_point(aes(x = Sabetta_x, y = Sabetta_y), size = 3, shape = 22, fill = "blue") +   geom_point(aes(x = Sabetta_x, y = Sabetta_y, group = 1), size = 3, shape = 22, fill = "blue") + 
  geom_point(aes(x = Terminal_x, y = Terminal_y, group = 1), size = 3, shape = 22, fill = "blue") +
  geom_polygon(data = chanel_df, aes(x = X, y = Y), fill = "black", group = 1) 
