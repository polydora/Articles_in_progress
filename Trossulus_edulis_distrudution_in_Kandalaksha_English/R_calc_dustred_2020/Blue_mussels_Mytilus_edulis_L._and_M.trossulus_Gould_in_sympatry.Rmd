...
all_sm_long %>% 
  ...
  facet_grid(Model ~ variable, scales = "free", switch = 'x') +
  guides(fill = "none") +
  scale_color_manual(values = c("black", "blue", "red") ) +
  scale_fill_manual(values = c("black", "blue", "red")) +
  geom_rug(data = predictors_rug, aes(x = value), lwd = 0.1) +
  theme(strip.background.x = element_blank(), legend.position = "bottom") +
  labs(x = "", color = "") +
  theme(strip.placement = "outside", panel.grid = element_blank())
  
  
# ggsave(filename = "Pl_all_smoothers.svg", plot = Pl_all_smoothers)
...
all_ds %>% 
  ...
  scale_fill_manual(values = c("gray30", "gray") ) +
   theme(strip.placement = "outside", panel.grid = element_blank(), strip.background.x = element_blank())

# ggsave(filename = "Pl_Ptros_Pi.svg", plot = Pl_Ptros_Pi)
...
# ggsave(filename = "Pl_Abundance.svg", plot = Pl_Abundance)
